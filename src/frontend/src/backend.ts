...
export class Backend implements backendInterface {
    ...
    async createVocabSet(arg0: string, arg1: string, arg2: Array<VocabEntry>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createVocabSet(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVocabSet(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteVocabSet(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVocabSet(arg0: string): Promise<VocabSet> {
        if (this.processError) {
            try {
                const result = await this.actor.getVocabSet(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listGameResults(): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.listGameResults();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordGameResult(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordGameResult(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
